  ...
  return (
    <StudentContext.Provider value={{ stdList, setStdList, user, setUser,favStd,setFavStd}} >
      <section className="bg-orange-400 flex justify-start gap-40 px-10 py-5 text-3xl ">
        ...
        <button className="bg-emerald-600 p-3 border rounded-lg border-none hover:bg-emerald-800 hover:underline" onClick={() => navigate("/favlist")} >Favorite Students</button>
